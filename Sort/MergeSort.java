...
public class MergeSort {
    ...
    public static void divide(int arr[],int si,int ei){
        ...
        //si=starting index
        //ei=ending index
        int mid=si+(ei-si)/2; //or (si+ei)/2; the diiference is time and space complexity if starting and ending index are very large soit can also go out of integer rangr so we donot use (si+ei)/2
        divide(arr,si,mid);
        divide(arr,mid+1,ei);
